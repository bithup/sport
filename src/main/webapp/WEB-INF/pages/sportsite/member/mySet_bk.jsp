        ...
        <div class="detail">
            <ul>
                ...
                <li>
                    ...
                    <input type="text" name="" value="${memberUser.nickName}">
                </li>
                <div class="no"></div>
                <li >
                    生日
                ...
                <li>
                    ...
                    <a href="javascript:void(0);"><img src="<%=uiPath%>site/images/my_zk.png" alt=""></a>
                    <i>CM</i>
                    <input type="text" name="" value="${memberUser.heigth}" class="self_height" >
                </li>
                <div class="no"></div>
                ...
                <li>
                    签名
                    <a href="javascript:void(0);"><img src="<%=uiPath%>site/images/my_zk.png" alt=""></a>
                    <input type="text" name="" value="${memberUser.signature}" class="self_intro">
                </li>
            </ul>
        </div>
        <div class="exit">
