...
<head>
    ...
    <script type="text/javascript">
        ...
        function h2y_save() {
            isSubmiting = true;
            var queryString ="kind="+$("#kind").val()+"&context="+$("#context").val()+"&remark="+"";
            $.post("/sportsite/recommend/addRecommend.htm", queryString, function (data) {
                ...
                if (jsonReturn.resultFlag == "1") {
                    ...
                    location.href="/sportsite/recommend/init.htm?kind=2"
                } else {
                    new Toast({message:jsonReturn.resultMsg}).show();
                }
        ...
        function reqData(reqUrl, op) {
            ...
            $.ajax({
                type: 'POST',
                url: reqUrl,
                data: {kind:2,page: page, pageSize: pageSize},
                dataType: 'json',
...
<div class="content">
    <div class="log_tit">
        ...
        <div class="log_tit02"><strong>我要挑毛病</strong></div>
    </div>
