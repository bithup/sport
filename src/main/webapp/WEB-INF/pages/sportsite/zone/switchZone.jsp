...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<%=uiPath%>site/css/place.css">
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $(".container").width(oW);
            //点击城市事件
            $(".city city-list p").on("click",function () {
                alert($(this).html());
            });
            ...
            $("p").click(function () {
                localStorage.setItem("cityName",$(this).html());
                location.href="/home/baseInfo.htm";
            });

            //搜索按钮点击事件
            $("#search_btn").click(function(){
                var cityStr=$("#search_ipt").val();
                if(cityStr==""||cityStr==null){
                    alert("请输入城市名称");
                    return false;
                }
                var city=$.trim(cityStr);
                var flag=0;
                var st="<div class='city-list'>";
                $(".city1 p").each(function(){
                    var oCity=$(this).html();
                    if(oCity.indexOf(city)!=-1){
                        flag+=1;
                        st+="<p>"+oCity+"</p>";
                    }
                ...
                if(flag==0){
//                    st="<div class='city-list'><p>没有查询到该城市</p><div>";
//                    $(".city").html(st);
                    alert("没有查询到该城市");
                } else {
                    st+="</div>";
        ...
        //                    var oCity=$(this);
        //                    var $oCity=oCity.html();
        //                    if($oCity.search($city)!=-1){
        //                        $(window).scrollTop($('#' +oCity.siblings("span").attr("id")).offset().top);
        //                    }
    </script>
</head>
<body>
<div class="content">
    <div class="head">
        <div class="return"><a href="javascript:history.go(-1)"><img src="<%=uiPath%>site/images/return.png" alt="" /></a></div>

        <div class="center">选择城市</div>
        <div class="right"><input type="text" placeholder="请输入城市名称" id="search_ipt" /><a id="search_btn">搜索</a></div>

    </div>
    <div class="no"></div>
    <%--展示查询出来的城市信息--%>
    <div id="match" style="z-index: 9999;display: none">
        <div class="city">
            <div id="mat" class="city-list">
            lsldkf
            </div>
        </div>
    </div>
    <div id="all" class="container" style="z-index: 9999">
        <div class="city">
    ...
    <div class="city1" style="display: none">
        <div class="city-list"><span class="city-letter" >A</span>
            <p data-id="210300">鞍山市</p>
            <p data-id="152900">阿拉善盟</p>
            <p data-id="340800">安庆市</p>
            <p data-id="410500">安阳市</p>
        ...
        <div class="city-list"><span class="city-letter" >B</span>
            <p data-id="220800">白城市</p>
            <p data-id="150200">包头市</p>
            <p data-id="150800">巴彦淖尔市</p>
            <p data-id="130600">保定市</p>
        ...
        <div class="city-list"><span class="city-letter" >C</span>
            <p data-id="140400">长治市</p>
            <p data-id="130900">沧州市</p>
            <p data-id="320400">常州市</p>
            <p data-id="330282">慈溪市</p>
        ...
        <div class="city-list"><span class="city-letter" >D</span>
            <p data-id="232700">大兴安岭地区</p>
            <p data-id="140200">大同市</p>
            <p data-id="230600">大庆市</p>
            <p data-id="321181">丹阳市</p>
        ...
        <div class="city-list"><span class="city-letter" >E</span>
            <p data-id="150600">鄂尔多斯市</p>
            <p data-id="420700">鄂州市</p>
            <p data-id="422800">恩施土家族苗族自治州</p>
        </div>
        <div class="city-list"><span class="city-letter" >F</span>
            <p data-id="210900">阜新市</p>
            <p data-id="210400">抚顺市</p>
            <p data-id="350181">福清市</p>
            <p data-id="341200">阜阳市</p>
        ...
        <div class="city-list"><span class="city-letter" >G</span>
            <p data-id="440100">广州市</p>
            <p data-id="360700">赣州市</p>
            <p data-id="510800">广元市</p>
            <p data-id="511600">广安市</p>
        ...
        <div class="city-list"><span class="city-letter" >H</span>
            <p data-id="231100">黑河市</p>
            <p data-id="211400">葫芦岛市</p>
            <p data-id="330481">海宁市</p>
            <p data-id="320800">淮安市</p>
        ...
        <div class="city-list"><span class="city-letter" >J</span>
            <p data-id="210700">锦州市</p>
            <p data-id="330700">金华市</p>
            <p data-id="140700">晋中市</p>
            <p data-id="320281">江阴市</p>
        ...
        <div class="city-list"><span class="city-letter" >K</span>
            <p data-id="320583">昆山市</p>
            <p data-id="410200">开封市</p>
            <p data-id="530100">昆明市</p>
            <p data-id="650200">克拉玛依市</p>
        ...
        <div class="city-list"><span class="city-letter" >L</span>
            <p data-id="141000">临汾市</p>
            <p data-id="131000">廊坊市</p>
            <p data-id="211000">辽阳市</p>
            <p data-id="220400">辽源市</p>
        ...
        <div class="city-list"><span class="city-letter" >M</span>
            <p data-id="231000">牡丹江市</p>
            <p data-id="340500">马鞍山市</p>
            <p data-id="510700">绵阳市</p>
            <p data-id="511400">眉山市</p>
        ...
        <div class="city-list"><span class="city-letter" >N</span>
            <p data-id="320100">南京市</p>
            <p data-id="330200">宁波市</p>
            <p data-id="320600">南通市</p>
            <p data-id="360100">南昌市</p>
        ...
        <div class="city-list"><span class="city-letter" >P</span>
            <p data-id="211100">盘锦市</p>
            <p data-id="360300">萍乡市</p>
            <p data-id="410400">平顶山市</p>
            <p data-id="410900">濮阳市</p>
        ...
        <div class="city-list"><span class="city-letter" >Q</span>
            <p data-id="130300">秦皇岛市</p>
            <p data-id="230200">齐齐哈尔市</p>
            <p data-id="230900">七台河市</p>
            <p data-id="350500">泉州市</p>
        ...
        <div class="city-list"><span class="city-letter" >R</span>
            <p data-id="320682">如皋市</p>
            <p data-id="371082">荣成市</p>
            <p data-id="371100">日照市</p>
            <p data-id="542301">日喀则市</p>
        </div>
        <div class="city-list"><span class="city-letter" >S</span>
            <p data-id="220300">四平市</p>
            <p data-id="231200">绥化市</p>
            <p data-id="220700">松原市</p>
            <p data-id="320500">苏州市</p>
        ...
        <div class="city-list"><span class="city-letter" >T</span>
            <p data-id="140100">太原市</p>
            <p data-id="211200">铁岭市</p>
            <p data-id="220500">通化市</p>
            <p data-id="130200">唐山市</p>
        ...
        <div class="city-list"><span class="city-letter" >W</span>
            <p data-id="330300">温州市</p>
            <p data-id="320200">无锡市</p>
            <p data-id="150900">乌兰察布市</p>
            <p data-id="150300">乌海市</p>
        ...
        <div class="city-list"><span class="city-letter" >X</span>
            <p data-id="140900">忻州市</p>
            <p data-id="152500">锡林郭勒盟</p>
            <p data-id="130500">邢台市</p>
            <p data-id="152200">兴安盟</p>
        ...
        <div class="city-list"><span class="city-letter" >Y</span>
            <p data-id="320282">宜兴市</p>
            <p data-id="222400">延边朝鲜族自治州</p>
            <p data-id="321000">扬州市</p>
            <p data-id="140800">运城市</p>
        ...
        <div class="city-list"><span class="city-letter" >Z</span>
            <p data-id="130700">张家口市</p>
            <p data-id="330681">诸暨市</p>
            <p data-id="321100">镇江市</p>
            <p data-id="320582">张家港市</p>
