...
import com.xgh.pay.util.IPUtil;
...
public class Configure {
    ...
    // 二级商户名称，可为空
    private static String sub_mrch = "郑州放上去网络科技有限公司";
    ...
    public static String httpsRequestClassName = "com.xgh.pay.comm.HttpsPostRequest";
