 ...
 * @version 1.1.2
 */
package com.xgh.pay.util;



import com.xgh.pay.common.Configure;
import com.xgh.pay.service.dl.DlFile;
import com.xgh.pay.service.dl.DlSettleFile;
import com.xgh.pay.service.ep.*;
import com.xgh.pay.service.gp.GpPay;
import com.xgh.pay.service.gp.GpQuery;
import com.xgh.pay.service.gp.GpRefund;
import com.xgh.pay.service.gp.GpRefundQuery;
import com.xgh.pay.service.py.*;
...
public class EPay {
     ...
     * @return 跳转页面HTML代码
     */
    public static String epAuth(String trac_no, String acct_type, String bank_no, String card_no, String user_name, String cert_no, String card_phone, String expireDate, String cvn,String order_desc) {
        ...
        if(order_desc!=null&&"".endsWith(order_desc))
    ...
    public static String epAuth(String trac_no, String acct_type, String bank_no, String card_no,String order_desc) {
        return epAuth(trac_no, acct_type, bank_no, card_no, order_desc, null, null, null, null,order_desc);
    }
